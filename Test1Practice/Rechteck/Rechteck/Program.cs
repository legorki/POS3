...
namespace TypesDemo.Application
{
    class TypeExercise
    {
        ...
        {
            int average = schuelerGesamt / klassenGesamt;
        ...
        {
            int vornamLänge = vorname?.Length ?? 0;
            int nachnamLänge = nachname?.Length ?? 0;

            return vornamLänge + nachnamLänge;
        }
